        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-gray-900 hidden sm:block">BJMP8 Automatic Job Description Generator</h1>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {viewMode === 'form' ? (
          <div className="bg-white shadow-xl rounded-2xl overflow-hidden max-w-4xl mx-auto">
            ...
            {/* Credit Line */}
            <p className="text-center text-xs text-gray-400 py-2 bg-gray-50 border-b border-gray-100">
              Developed by: BJMP8-RICTMD
            </p>
